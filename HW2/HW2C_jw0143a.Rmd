...
```{r error=FALSE, message=TRUE, warning=FALSE, include=TRUE}
...
> Note the high p-value of `r chSq$p.value`, which is immediately indicative that, at the very least in the context of this sample size, there is absolutely no phenomenon event happening. \